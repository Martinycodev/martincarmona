...
- [x] En la vista de propietario y de trabajador, quiero que se vean las tareas de 15 en 15 con paginación. Incluso podríamos filtrar por año. Para que vea solo las de este año y en caso de querer buscar vea las de años anteriores.
- [x] En la vista de trabajador quiero que aparezcan el alta en la seguridad social o la baja.
- [x] Tambien quiero que el trabajador vea el nombre del usuario de empresa y ponga Empresa: [nombre empresa]
-  En el rol de trabajador, cambiar el color de la deuda del trabajador, lo que le debe la empresa al trabajador el lo ve como positivo por lo que debería de ser verde.
