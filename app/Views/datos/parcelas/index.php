            ...
            <div class="parcela-main-info">
                <div class="parcela-avatar">
                    <?php if (!empty($parcela['foto'])): ?>
                        <img src="<?= htmlspecialchars($parcela['foto']) ?>" alt="Foto de la parcela" class="avatar-img">
                    <?php else: ?>
        ...
        <div class="parcela-details">
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    ...
                    <div class="detail-item">
                        <label>Dueño:</label>
                        <span><?= htmlspecialchars($parcela['dueño'] ?? '-') ?></span>
                    </div>
                    <div class="detail-item">
                        <label>Empresa:</label>
            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    <div class="detail-item">
                        ...
                        <span class="future-field"><?= htmlspecialchars($parcela['referencia_catastral'] ?? 'No disponible') ?></span>
                    </div>
                    <div class="detail-item">
                        <label>Superficie:</label>
                        <span class="future-field"><?= $parcela['superficie'] ? number_format($parcela['superficie'], 2) . ' ha' : 'No disponible' ?></span>
                    </div>
                    <div class="detail-item">
                        <label>Tipo de Cultivo:</label>
                        <span class="future-field"><?= htmlspecialchars($parcela['tipo_cultivo'] ?? 'No disponible') ?></span>
                    </div>
                    <div class="detail-item">
                        <label>Fecha de Plantación:</label>
                        <span class="future-field"><?= $parcela['fecha_plantacion'] ? date('d/m/Y', strtotime($parcela['fecha_plantacion'])) : 'No disponible' ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    <div class="detail-item">
                        ...
                        <span class="future-field"><?= $parcela['rendimiento_anual'] ? number_format($parcela['rendimiento_anual'], 2) . ' kg/ha' : 'No disponible' ?></span>
                    </div>
                    <div class="detail-item">
                        <label>Kilos Último Año:</label>
                        <span class="future-field"><?= $parcela['kilos_ultimo_ano'] ? number_format($parcela['kilos_ultimo_ano'], 2) . ' kg' : 'No disponible' ?></span>
                    </div>
                    <div class="detail-item">
                        <label>Última Cosecha:</label>
                        <span class="future-field"><?= $parcela['ultima_cosecha'] ? date('d/m/Y', strtotime($parcela['ultima_cosecha'])) : 'No disponible' ?></span>
                    </div>
                </div>
            </div>
