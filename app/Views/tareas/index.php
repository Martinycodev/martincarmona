                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div class="multi-select-wrapper">
                            ...
                            <div class="autocomplete-wrapper">
                                <input type="text" id="createParcela" name="parcela_busqueda"
                                    placeholder="Buscar parcela..." autocomplete="off">
                                <div id="createParcelaResults" class="autocomplete-results" style="display: none;">
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="multi-select-wrapper">
                            ...
                            <!-- Input de búsqueda -->
                            <div class="autocomplete-wrapper">
                                <input type="text" id="createTrabajador" name="trabajador_busqueda"
                                    placeholder="Buscar trabajador..." autocomplete="off">
                                <div id="createTrabajadorResults" class="autocomplete-results" style="display: none;">
                                </div>
                            </div>
                ...
                <?php if (!empty($tareas)): ?>
                    <?php foreach ($tareas as $tarea): ?>
                        <tr data-id="<?= $tarea['id'] ?>">
                            ...
                            <td class="description-cell"><?= htmlspecialchars($tarea['descripcion'] ?? 'Sin descripción') ?>
                            </td>
                            <td><?= $tarea['horas'] ? number_format($tarea['horas'], 1) . 'h' : '0h' ?></td>
                            <td class="actions">
                                <button class="btn-icon btn-info" onclick="viewTarea(<?= $tarea['id'] ?>, this)"
                                    title="Ver más">
                                    👁️
                                </button>
                                <button class="btn-icon btn-delete"
                                    onclick="deleteTarea(<?= $tarea['id'] ?>, '<?= htmlspecialchars($tarea['descripcion'] ?? 'Sin descripción') ?>')"
                                    title="Eliminar">
                                    🗑️
                                </button>
                            </td>
    ...
    <?php if (isset($pagination) && $pagination['totalPages'] > 1): ?>
        <div class="pagination-container">
            ...
            <div class="pagination-controls">
                ...
                <!-- Botón Anterior -->
                <?php if ($pagination['hasPrev']): ?>
                    <a href="<?= $this->url('/tareas') ?>?page=<?= $pagination['currentPage'] - 1 ?>"
                        class="btn-pagination btn-prev" title="Página anterior">
                        ◀️
                    </a>
                <?php else: ?>
                ...
                <?php if ($pagination['hasNext']): ?>
                    <a href="<?= $this->url('/tareas') ?>?page=<?= $pagination['currentPage'] + 1 ?>"
                        class="btn-pagination btn-next" title="Página siguiente">
                        ▶️
                    </a>
                <?php else: ?>
                ...
                <!-- Botón Última Página -->
                <?php if ($pagination['hasNext']): ?>
                    <a href="<?= $this->url('/tareas') ?>?page=<?= $pagination['totalPages'] ?>" class="btn-pagination btn-last"
                        title="Última página">
                        ⏭️
                    </a>
                <?php else: ?>
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form id="editTareaForm">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div class="multi-select-wrapper">
                            ...
                            <!-- Input de búsqueda -->
                            <div class="autocomplete-wrapper">
                                <input type="text" id="editParcela" name="parcela_busqueda"
                                    placeholder="Buscar parcela..." autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <div class="multi-select-wrapper">
                            ...
                            <!-- Input de búsqueda -->
                            <div class="autocomplete-wrapper">
                                <input type="text" id="editTrabajador" name="trabajador_busqueda"
                                    placeholder="Buscar trabajador..." autocomplete="off">
                                <div id="editTrabajadorResults" class="autocomplete-results" style="display: none;">
                                </div>
                            </div>
                ...
                <div class="modal-buttons">
                    <button type="button" class="btn-modal btn-danger" onclick="deleteTareaFromEdit()">🗑️
                        Eliminar</button>
...
<script>
    ...
    function closeViewModal() {
        ...
        // Recargar si hubo cambios directos
    ...
    document.getElementById('editTareaForm').addEventListener('submit', async function (e) {
        ...
        try {
            ...
            if (data.success) {
                ...
                await uploadImages(tareaData.id, 'editTaskImagenes');
