                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div class="multi-select-wrapper">
                            ...
                            <div class="autocomplete-wrapper">
                                <input type="text" id="editTaskParcela" name="parcela_busqueda"
                    ...
                    <div class="form-group">
                        ...
                        <div class="multi-select-wrapper">
                            ...
                            <!-- Input de búsqueda -->
                            <div class="autocomplete-wrapper">
                                <input type="text" id="editTaskTrabajador" name="trabajador_busqueda"
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div class="multi-select-wrapper">
                            ...
                            <!-- Input de búsqueda -->
                            <div class="autocomplete-wrapper">
                                <input type="text" id="createTaskParcela" name="parcela_busqueda"
                                    placeholder="Buscar parcela..." autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <div class="multi-select-wrapper">
                            ...
                            <!-- Input de búsqueda -->
                            <div class="autocomplete-wrapper">
                                <input type="text" id="createTaskTrabajador" name="trabajador_busqueda"
                                    placeholder="Buscar trabajador..." autocomplete="off">
