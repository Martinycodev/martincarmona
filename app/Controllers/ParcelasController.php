...
class ParcelasController extends BaseController
{
    ...
    public function crear()
    {
        ...
        try {
            ...
            $stmt = $db->prepare("INSERT INTO parcelas (nombre, olivos, ubicacion, empresa, dueño, hidrante, descripcion, id_user) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
            $stmt->bind_param("sisssiis", $nombre, $olivos, $ubicacion, $empresa, $dueño, $hidrante, $descripcion, $_SESSION['user_id']);
    ...
    public function actualizar()
    {
        ...
        try {
            ...
            $stmt = $db->prepare("UPDATE parcelas SET nombre = ?, olivos = ?, ubicacion = ?, empresa = ?, dueño = ?, hidrante = ?, descripcion = ? WHERE id = ?");
            $stmt->bind_param("sisssiis", $nombre, $olivos, $ubicacion, $empresa, $dueño, $hidrante, $descripcion, $id);
